...
debug:
	nvcc -o debug.out Source/main.cu Source/Kernels.cu Source/UnitTests.cu Source/RFIM.cu Source/RFIMHelperFunctions.cu Source/UtilityFunctions.cu Source/RFIMMemoryStruct.cu Source/RFIMMemoryStructBatched.cu Source/RFIMMemoryStructComplex.cu Source/Benchmark.cu Source/CudaUtilityFunctions.cu -lcurand -lcublas -lcusolver -g -G -O0 -std=c++11
