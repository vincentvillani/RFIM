...
debugMulti:
	nvcc -o debugMultiStream.out Source/main.cu Source/Kernels.cu Source/UnitTests.cu Source/RFIM.cu Source/RFIMHelperFunctions.cu Source/CudaUtilityFunctions.cu Source/UtilityFunctions.cu Source/RFIMMemoryStruct.cu Source/Benchmark.cu -lcurand -lcublas -lcusolver -g -G -O0 -std=c++11
